 ...
 * [gctm.yml](gctm.yml)
     * Determines how your purl.obolibrary.org/obo/gctm/ redirects will be handled
     ...
     * Paste in the contents of [gctm.yml](gctm.yml)
 ...
 * [gctm.md](gctm.md)
     ...
     * Paste in the contents of [gctm.md](gctm.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
